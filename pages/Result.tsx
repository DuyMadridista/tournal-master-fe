    ...
    try {
      ...
      const allMatches: Match[] = data.data.flatMap(group =>
        group.matches.map(match => ({
          ...
          team1: { id: match.teamOneId?.toString(), name: match.teamOneName ?? "Tobe decided...", leaderName: "", leaderEmail: "", phoneNumber: "", playerCount: 0 },
          team2: { id: match.teamTwoId?.toString(), name: match.teamTwoName ?? "Tobe decided...", leaderName: "", leaderEmail: "", phoneNumber: "", playerCount: 0 },
          venue: match.title || "",
          round: undefined,
          group: undefined,
